...
public class ModStatusEffectInstance {
    ...
    public static final StatusEffectInstance WATER_RESISTANCE_EFFECT_5MIN = new StatusEffectInstance(ModStatusEffects.WATER_RESISTANCE, 6000, 0); // 5 minutes water resistance effect
