...
public class ModPotions {
    ...
    public static Item POTION_RECIPE = ConfigUtils.getItem(Hwr.CONFIG.potion_recipe(), "minecraft:sponge");

    public static Potion registerPotion(String name, StatusEffectInstance statusEffectInstance) {
        return Registry.register(Registry.POTION, new Identifier(Hwr.MOD_ID, name), new Potion(statusEffectInstance));
    }
